    ...
    for i in range(101, 201):
        ...
        #---write code here---
            ...
            for block in blocks:
                ...
                center = block.find('div', class_="jsx-2127947714 centers d-flex")
                
                if center is not None:
                    cn = center.find('span', class_="jsx-2127947714 text-dark f-14 lh-20 font-weight-medium mx-1").text
                    centres.append(cn)
...
try:        
    fields = {
        ...
        "Institute_Place":id.institute_location,
        "Institute_Rating":id.institute_rating,
        "Institute_Summary":id.institute_summary,
        "Institute_Info":id.institute_content,
        "Courses_Details":id.courses_details
        }

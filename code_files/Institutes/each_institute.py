    ...
    for i in range(201, 235):
        ...
        #---write code here---
            ...
            for block in blocks:
                ...
                center = block.find('div', class_="jsx-1986188473 centers d-flex")
                
                if center is not None:
                    arr = []
                    cn = center.find('span', class_="jsx-1986188473 text-dark f-14 lh-20 font-weight-medium mx-1").text.split(",")
...
try:        
    fields = {
        ...
        "Institute_City":id.institute_location,
        "Institute_Rating":id.institute_rating,
        "Institute_Summary":id.institute_summary,
        "Institute_Content":id.institute_content,
        "Institute_Courses":id.courses_details
        }
    ...
    for i in range(num_chunks):
        ...
        # csv_file_path = f'extracted_files\Institute_detailed\Institute_data_{i+1}.csv'
        # new_df.to_csv(csv_file_path, index=False)
        
        json_file_path = f'extracted_files\Institute_detailed\Institute_data_{i+21}.json'

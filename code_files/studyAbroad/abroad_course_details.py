...
try:
    ...
    def getAbroadDetails(c_link):
        ...
        #     condition = info.find('span', class_="jsx-1056176865 info-text text-capitalize")
        #     if condition is not None:
        #         cond = condition.text
    
        #     statement = info.find('span', class_="jsx-1056176865 d-block text-md text-capitalize")
        #     if statement is not None:
        #         stat = statement.text.strip()
                
            
        #     if cond == 'Location':
        #         college_location.append(stat)
        ...
        if cr_cards is not None:
            ...
            for course_card in course_cards:
                ...
                if course_grad is not None:
                    ...
                    each_course_details['Course Language'] = ""
                ...
                if course_fees is not None:
                    ...
                    each_course_details['Course Fees'] = ""
                ...
                cc_name.append(each_course_details['Course Name'])
                cc_year.append(each_course_details['Course Duration'])
                cc_degree.append(each_course_details['Course Degree'])
                cc_grad.append(each_course_details['Course Language'])
                cc_time.append(each_course_details['Course Time'])
                cc_fees.append(each_course_details['Course Fees'])
            
            
            Courses_name.append(cc_name)
            Courses_year.append(cc_year)
            Courses_degree.append(cc_degree)
            Courses_grad.append(cc_grad)
            Courses_time.append(cc_time)
            Courses_fees.append(cc_fees)
